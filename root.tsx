...
export const links: Route.LinksFunction = () => [
  ...
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Archivo:wght@200;300;400;500;700&family=Marcellus&family=Space+Mono:wght@400;700&display=swap",
  },
];
  ...
  return (
    <html lang="en" suppressHydrationWarning className={rootCssClass} style={{ colorScheme: resolvedScheme }}>
      <head>
        ...
        <Meta />
        <script src={colorSchemeApi} data-light-class="light-theme" data-dark-class="dark-theme" />
        <Links />
      </head>
      <body>
        {children}
