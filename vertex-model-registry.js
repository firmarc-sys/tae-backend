...
export const VERTEX_MODEL_CATALOG = Object.freeze({
  GEMINI_3_7_FLASH: model({
    id: "gemini-3.7-flash", lifecycle: "GA", qualityClass: "ADVANCED", latencyClass: "FAST", costClass: "BALANCED",
  ...
  GEMINI_3_6_FLASH: model({
    id: "gemini-3.6-flash", lifecycle: "GA", qualityClass: "ADVANCED", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 1048576, maxOutputTokens: 65536,
    inputModalities: ["text", "image", "audio", "video"], outputModalities: ["text"],
    features: ["system_instruction", "structured_output", "function_calling", "google_search", "grounding", "code_execution", "count_tokens"],
    locations: ["global", "us", "eu"],
  ...
  GEMINI_3_5_FLASH: model({
    id: "gemini-3.5-flash", lifecycle: "GA", qualityClass: "GENERAL", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 1048576, maxOutputTokens: 65536,
    inputModalities: ["text", "image", "audio", "video"], outputModalities: ["text"],
    features: ["system_instruction", "structured_output", "function_calling", "google_search", "grounding", "code_execution", "count_tokens"],
    locations: ["global", "us", "eu"],
  ...
  GEMINI_3_5_FLASH_LITE: model({
    id: "gemini-3.5-flash-lite", lifecycle: "GA", qualityClass: "FAST", latencyClass: "LOW", costClass: "ECONOMY",
    contextWindow: 1048576, maxOutputTokens: 65536,
    inputModalities: ["text", "image", "audio", "video"], outputModalities: ["text"],
    features: ["system_instruction", "structured_output", "function_calling", "google_search", "grounding", "code_execution", "count_tokens"],
    locations: ["global", "us", "eu"],
  ...
  GEMINI_3_1_FLASH_LITE: model({
    id: "gemini-3.1-flash-lite", lifecycle: "GA", qualityClass: "FAST", latencyClass: "LOW", costClass: "ECONOMY",
    contextWindow: 1048576, maxOutputTokens: 65536,
    inputModalities: ["text", "image", "audio", "video"], outputModalities: ["text"],
  ...
  GEMINI_3_1_PRO_PREVIEW: model({
    id: "gemini-3.1-pro-preview", lifecycle: "PREVIEW", qualityClass: "ADVANCED", latencyClass: "QUALITY", costClass: "PREMIUM",
    contextWindow: 1048576, maxOutputTokens: 65536,
    inputModalities: ["text", "image", "audio", "video"], outputModalities: ["text"],
    features: ["system_instruction", "structured_output", "function_calling", "google_search", "grounding", "code_execution", "count_tokens"],
    locations: ["global"], previewApprovalKey: "VERTEX_APPROVE_PREVIEW_REASONING",
  }),
  GEMINI_3_1_FLASH_IMAGE: model({
    id: "gemini-3.1-flash-image", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 131072, maxOutputTokens: 32768,
    inputModalities: ["text", "image", "video"], outputModalities: ["text", "image"],
    features: ["system_instruction", "image_generation", "image_editing", "count_tokens"], locations: ["global", "us", "eu"],
  }),
  GEMINI_3_PRO_IMAGE: model({
    id: "gemini-3-pro-image", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "QUALITY", costClass: "PREMIUM",
    contextWindow: 65536, maxOutputTokens: 32768,
    inputModalities: ["text", "image"], outputModalities: ["text", "image"],
    features: ["system_instruction", "image_generation", "image_editing"], locations: ["global"],
  }),
  GEMINI_3_1_FLASH_LITE_IMAGE: model({
    id: "gemini-3.1-flash-lite-image", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "LOW", costClass: "ECONOMY",
    contextWindow: 65536, maxOutputTokens: 4096,
    inputModalities: ["text", "image", "video"], outputModalities: ["text", "image"],
    features: ["system_instruction", "image_generation", "image_editing", "count_tokens"], locations: ["global"],
  }),
  VEO_3_1: model({
    id: "veo-3.1-generate-001", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "QUALITY", costClass: "PREMIUM",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text", "image", "video"], outputModalities: ["video", "audio"],
    features: ["video_generation", "native_audio"], locations: ["us-central1"],
  }),
  VEO_3_1_FAST: model({
    id: "veo-3.1-fast-generate-001", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text", "image", "video"], outputModalities: ["video", "audio"],
    features: ["video_generation", "native_audio"], locations: ["us-central1"],
  }),
  VEO_3_1_LITE_PREVIEW: model({
    id: "veo-3.1-lite-generate-001", lifecycle: "PREVIEW", qualityClass: "SPECIALIZED", latencyClass: "FAST", costClass: "ECONOMY",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text", "image", "video"], outputModalities: ["video", "audio"],
    features: ["video_generation", "native_audio"], locations: ["us-central1"], previewApprovalKey: "VERTEX_APPROVE_PREVIEW_VIDEO",
  }),
  LYRIA_3_PRO_PREVIEW: model({
    id: "lyria-3-pro-preview", lifecycle: "PREVIEW", qualityClass: "SPECIALIZED", latencyClass: "QUALITY", costClass: "PREMIUM",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text"], outputModalities: ["audio"], features: ["music_generation"],
    locations: ["global"], previewApprovalKey: "VERTEX_APPROVE_PREVIEW_AUDIO",
  }),
  LYRIA_3_CLIP_PREVIEW: model({
    id: "lyria-3-clip-preview", lifecycle: "PREVIEW", qualityClass: "SPECIALIZED", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text"], outputModalities: ["audio"], features: ["music_generation"],
    locations: ["global"], previewApprovalKey: "VERTEX_APPROVE_PREVIEW_AUDIO",
  }),
  GEMINI_LIVE_2_5_FLASH_NATIVE_AUDIO: model({
    id: "gemini-live-2.5-flash-native-audio", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "REALTIME", costClass: "BALANCED",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text", "audio"], outputModalities: ["text", "audio"],
    features: ["live", "native_audio", "function_calling"], locations: ["global"],
  }),
  GEMINI_EMBEDDING_2: model({
    id: "gemini-embedding-2", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text"], outputModalities: ["embedding"], features: ["embedding"],
    locations: ["global", "us", "eu"],
  }),
  GEMINI_EMBEDDING_001: model({
    id: "gemini-embedding-001", lifecycle: "GA", qualityClass: "SPECIALIZED", latencyClass: "FAST", costClass: "BALANCED",
    contextWindow: 0, maxOutputTokens: 0, inputModalities: ["text"], outputModalities: ["embedding"], features: ["embedding"],
    locations: ["global", "us", "eu"],
  }),
});
...
const capability = (spec) => Object.freeze({
  provider: VERTEX_PROVIDER, enabled: true, secondary_model: null, tertiary_model: null, ...spec,
...
export const CAPABILITY_ALIASES = Object.freeze({
  ...
  audio: "AUDIO_GENERATION", music: "AUDIO_GENERATION", audio_generation: "AUDIO_GENERATION", live: "LIVE", voice: "LIVE", embedding: "EMBEDDING", embeddings: "EMBEDDING",
});
